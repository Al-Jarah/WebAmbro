            ...
            <div>
                <div className="home-element">    
                        ...
                        <div className="jumbo-text">
                            <p className="home-top-text">Looking for a fresh creative design, a new application, or maybe just want to integrate the newest technologies into your existing software.
